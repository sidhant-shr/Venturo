          ...
          <div className="row align-items-center justify-content-center">
            <div className="col-lx-4 col-lg-5 col-sm-10">
              <div className="contact-info-text mb-md-70">
                ...
                <p>
                  Donor loyalty is not about the donor being loyal to you, it is
                  you being loyal to the donor.
                </p>
                <Link href="/events">
                  <a className="main-btn mt-35">
                    Checkout Events <i className="far fa-arrow-right" />
                  </a>
                </Link>
              </div>
            </div>
